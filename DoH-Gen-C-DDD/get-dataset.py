...
def clean_directory(base_dir):
    ...
    os.remove("0_chrome_dnsforge-tlsflowdata.csv")
    os.remove("0_chrome_dohli-tlsflowdata.csv")
...
def get_dataset_csv(base_dir):
    ...
    """
    uncompressed_file = os.path.join(base_dir,"DoH-Gen-C-DDD","data","generated","tls-flow-csv","chrome","dnsforge","0_chrome_dnsforge-tlsflowdata.csv")
    shutil.copy(uncompressed_file,".")
    uncompressed_file = os.path.join(base_dir,"DoH-Gen-C-DDD","data","generated","tls-flow-csv","chrome","dohli","0_chrome_dohli-tlsflowdata.csv")
    shutil.copy(uncompressed_file,".")
...
# Run action
zenodo_url = "https://zenodo.org/records/5957677/files/DoH-Gen-C-DDD.tar.gz?download=1"
base_directory = 'extracted_data'
download_and_extract_tar_gz(zenodo_url, base_directory)
get_dataset_csv(base_directory)
concatenate_files("0_chrome_dnsforge-tlsflowdata.csv", "0_chrome_dohli-tlsflowdata.csv","merged-doh-tls-dataset.csv")
