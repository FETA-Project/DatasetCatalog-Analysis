...
def get_dataset_csv(base_dir):
    ...
    """
    uncompressed_file = os.path.join(base_dir, "ip_addresses_sample","agg_1_hour","11.csv")
...
# Run action
zenodo_url = "https://zenodo.org/records/13382427/files/ip_addresses_sample.tar.gz?download=1"
download_and_extract_tar_gz(zenodo_url, 'extracted_data')
