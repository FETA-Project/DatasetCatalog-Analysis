...
df = pd.read_csv("../../datasets/CESNET-MINERS22-PPI/miners-design.csv")
...
with open('../../datasets/CESNET-MINERS22-PPI/drift/logs_cesnet_miners22_ppi-design-retrained.pkl', 'wb') as outp:
