...
def load_csv_dataset(path: str):
    ...
    df.to_csv("miners_evaluation.csv", sep=',', index=False, encoding='utf-8',quoting=csv.QUOTE_NONE, escapechar=' ', mode = "w")

load_csv_dataset("../cesnet-miner22/decrypto_dataset_evaluation.csv")
