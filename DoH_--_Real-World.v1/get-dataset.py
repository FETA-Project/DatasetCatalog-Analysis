...
def clean_directory(base_dir):
    ...
    os.remove("HTTPS-04102021-01h-1-tlsflowdata.csv")
    os.remove("DoH-01082021-48h-tlsflowdata.csv")
...
def get_dataset_csv(base_dir):
    ...
    """
    uncompressed_file = os.path.join(base_dir,"DoH-Real-World","data","captured","tls-flow-csv","DoH-01082021-48h-tlsflowdata.csv")
    shutil.copy(uncompressed_file,".")
    uncompressed_file = os.path.join(base_dir,"DoH-Real-World","data","captured","tls-flow-csv","HTTPS-04102021-01h-1-tlsflowdata.csv")
    shutil.copy(uncompressed_file,".")
...
# Run action
zenodo_url = "https://zenodo.org/records/5956044/files/DoH-Real-World.tar.gz?download=1"
base_directory = 'extracted_data'
download_and_extract_tar_gz(zenodo_url, base_directory)
get_dataset_csv(base_directory)
concatenate_files("DoH-01082021-48h-tlsflowdata.csv", "HTTPS-04102021-01h-1-tlsflowdata.csv","merged-doh-tls-dataset.csv")
