...
def uncompress_to_csv(base_dir):
  ...
  """
  try:
    compressed_file = os.path.join(base_dir, "W-2021-40", "1_Mon", "flows-20211004.csv.gz")
    uncompressed_file = os.path.join("flows-20211004.csv")
...
# Run action
zenodo_url = "https://zenodo.org/records/10610895/files/cesnet-tls22.zip?download=1"
